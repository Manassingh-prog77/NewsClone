...
export class News extends Component {
    ...
    constructor(props){
        ...
        document.title = `${this.capitalizeFirstWord(this.props.category)} - NewsUpdater`;
    }
    async update(){
  ...
  render() {
    return (
      ...
      <div className='container my-3'>
        <h1 className='text-center' style={{margin: "35px"}}>NewsUpdater - Top {this.capitalizeFirstWord(this.props.category)} Headlines</h1>
